...
function HandleChallengesList(a_Split, a_Player)
...
function HandleChallengesInfo(a_Split, a_Player)
	if (#a_Split == 2) then
...
function HandleChallengesComplete(a_Split, a_Player)
	local playerInfo = GetPlayerInfo(a_Player)
...
function HandleChallengesCheck(a_Split, a_Player)
	if (#a_Split < 4) then
